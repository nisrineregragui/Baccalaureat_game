...
public class HelloApplication extends Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Test Banane/Animal/B : " + api.verify_word("Banane", "Animal", 'B'));
        ...
        System.out.println("test 1(Casablanca/Ville/C) : " + (test1 ? "RÉUSSI" : "ÉCHEC ") + " en " + (endTime - startTime) + "ms");
        //test 2 false
        boolean test2 = validationService.word_validation("Lyon", 'P', 1);
        System.out.println("test2(Lyon/Ville/P) : " + (!test2 ? "RÉUSSI (Refusé car mauvaise lettre) " : "ÉCHEC "));
